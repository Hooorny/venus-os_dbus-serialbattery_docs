...
| Bluetooth connection <sup>(3)</sup> <img src="/venus-os_dbus-serialbattery_docs/img/bluetooth.svg" className="h-1em" /> | No    | No    | No                 | No            | No     | No            | No            | Yes              | No             | Yes     | No                 | No     | No     | No        | No                        |
